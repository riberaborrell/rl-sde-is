...
from sderl_tabular.utils_path import get_sarsa_lambda_dir_path
...
def main():
    ...
    # get dir path
    agent.set_dir_path()
    agent.dir_path = get_sarsa_lambda_dir_path(
        env_dir_path=agent.dir_path,
        h_state=args.h_state,
        h_action=args.h_action,
        explorable_starts=args.explorable_starts,
        x_init=args.x_init,
        alpha=args.alpha,
        lam=args.lam,

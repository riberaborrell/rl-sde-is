...
def update_parameters(actor, actor_target, actor_optimizer,
    ...
    with torch.no_grad():
        ...
        next_actions_smoothed = next_actions + target_noise * torch.randn_like(next_actions)
...
def td3_episodic(env, gamma=1., n_layers=3, d_hidden_layer=32, n_episodes=100, n_steps_lim=1000,
                 learning_starts=1000, expl_noise_init=1.0, expl_noise_decay=1., replay_size=50000,
